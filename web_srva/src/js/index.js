document.addEventListener('DOMContentLoaded', () => {
    ...
    /* =========================================
       2. Search XSS Vulnerability Logic
       ========================================= */
    ...
    if (searchQuery && searchResults) {
        ...
        searchResults.innerHTML = `<p>You searched for: <strong>${searchQuery}</strong></p>`;
    }

    /* =========================================
       3. Contact Form (Stored XSS Demo)
       ========================================= */
    ...
    // Only initialize Chatbot if elements exist (prevents errors on other pages)
